...
app.use(logger('dev'));  // log the errors only in a production environment. Users wont see the errors 
...
module.exports = app;  //  the instance of express object is available throughoout the application 
